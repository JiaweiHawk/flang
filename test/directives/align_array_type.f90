...
submodule (module_align_array) submodule_align_array
    ...
    module subroutine module_interface_subroutine()
        ...
        !dir$ align 256
        integer, dimension (5,5) :: v3

        !dir$ align 256
        integer, dimension (5,5) :: v4
...
implicit none
    ...
    !dir$ align 512
    integer, dimension (5,5) :: v5

    !dir$ align 512
    integer, dimension (5,5) :: v6
...
subroutine subroutine_align()
    ...
    !dir$ align 1024
    integer, dimension (5,5) :: v7

    !dir$ align 1024
    integer, dimension (5,5) :: v8
...
function function_align()
    ...
    !dir$ align 2048
    integer, dimension (5,5) :: v9

    !dir$ align 2048
    integer, dimension (5,5) :: v10
