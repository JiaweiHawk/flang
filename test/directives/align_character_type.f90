...
! CHECK: @[[BLOCK1]] = common global %struct[[BLOCK1]] zeroinitializer, align 128
...
! CHECK:      store volatile i64 %{{[0-9]+}}, ptr @[[BLOCK1]], align
    ...
    v2 = "82"
! CHECK:      %[[TEMP:[0-9]+]] = getelementptr i8, ptr @[[BLOCK1]], i64 128
